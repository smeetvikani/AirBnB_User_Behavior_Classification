...
#add a div for dropdown.

app.layout = html.Div(children=[
    html.H1(children='User Activity Report'),
    html.Div(children='''Global User Activity Report.'''),
    dcc.Graph(
        id='example-graph',
        figure={
            ...
            'layout':
            go.Layout(title='Activity by User', barmode='stack')
        })
])
